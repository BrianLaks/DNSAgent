# DNS Agent - Feature Showcase 🛡️🚀

DNS Agent is a professional-grade DNS management and network protection suite. Below are the key features and screens that make DNS Agent the ultimate choice for network privacy and performance.
...
### 📈 Hosts Analytics & Traffic Distribution
Understand which devices are most active on your network. DNS Agent groups and analyzes traffic by hostname, giving you a clear view of your network's footprint.
...
Built-in security with ASP.NET Core Identity. Separate Admin and User roles ensure that sensitive network settings are protected while analytics remain accessible.

---

## 🚀 Get Started Today
Run `Setup-DNSAgent.ps1` in the root folder to activate your network shield in seconds!
